                ...
                <div className="grid grid-cols-5 gap-3">
                  {councilmen.map(c => {
                    ...
                    return (
                      <div 
                        key={c.id} 
                        className={`bg-slate-900/90 rounded-xl overflow-hidden flex flex-col items-center border transition-all duration-500 group ${
                          !c.isPresent ? 'border-white/5 opacity-40 grayscale scale-[0.98]' :
                      ...
                      >
                        <div className="relative w-full aspect-[3/4] overflow-hidden bg-slate-800 border-b border-white/5">
                           ...
                           <div className={`absolute top-2 left-2 z-10 px-2 py-0.5 rounded-full text-[6px] font-black uppercase tracking-widest backdrop-blur-md border ${
                             c.isPresent 
                        ...
                        <div className={`w-full py-1.5 text-center text-[10px] font-black uppercase tracking-[0.2em] transition-all ${
                          !c.isPresent ? 'bg-black/90 text-white/5' :
