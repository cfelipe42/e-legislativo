...
export const INITIAL_COUNCILMEN: Councilman[] = [
  { id: '1', name: 'Ana Silva', party: 'PT', city: 'Almenara', isPresent: false, currentVote: VoteValue.PENDING, avatar: 'https://picsum.photos/seed/ana/100/100' },
  { id: '2', name: 'Bruno Mendes', party: 'PL', city: 'Almenara', isPresent: false, currentVote: VoteValue.PENDING, avatar: 'https://picsum.photos/seed/bruno/100/100' },
  { id: '3', name: 'Carla Souza', party: 'MDB', city: 'Almenara', isPresent: false, currentVote: VoteValue.PENDING, avatar: 'https://picsum.photos/seed/carla/100/100' },
  { id: '4', name: 'Diego Ramos', party: 'PSDB', city: 'Almenara', isPresent: false, currentVote: VoteValue.PENDING, avatar: 'https://picsum.photos/seed/diego/100/100' },
  { id: '5', name: 'Elena Costa', party: 'REDE', city: 'Almenara', isPresent: false, currentVote: VoteValue.PENDING, avatar: 'https://picsum.photos/seed/elena/100/100' },
  { id: '6', name: 'Fabio Junior', party: 'PP', city: 'Almenara', isPresent: false, currentVote: VoteValue.PENDING, avatar: 'https://picsum.photos/seed/fabio/100/100' },
  { id: '7', name: 'Gisele B.', party: 'PV', city: 'Almenara', isPresent: false, currentVote: VoteValue.PENDING, avatar: 'https://picsum.photos/seed/gisele/100/100' },
  { id: '8', name: 'Hugo Lima', party: 'PDT', city: 'Almenara', isPresent: false, currentVote: VoteValue.PENDING, avatar: 'https://picsum.photos/seed/hugo/100/100' },
  { id: '9', name: 'Iara Neves', party: 'PSOL', city: 'Almenara', isPresent: false, currentVote: VoteValue.PENDING, avatar: 'https://picsum.photos/seed/iara/100/100' },
];
